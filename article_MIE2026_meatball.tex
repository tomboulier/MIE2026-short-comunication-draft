...
\author[B]{\fnms{Alexandre} \snm{GODON}},
\author[B]{\fnms{Sebastien} \snm{MARQUET}},
\author[A,B]{\fnms{Thomas} \snm{BOULIER}%
...
\address[A]{Univ. Grenoble Alpes, CNRS, UMR 5525, VetAgro Sup, Grenoble INP, Grenoble Alpes University Hospital, TIMC, Grenoble, France}
\address[B]{Univ. Grenoble Alpes, Department of Anaesthesia and Intensive Care, Grenoble Alpes University Hospital, Grenoble, France}
...
As an example, Figure~\ref{fig:pbm_trends} illustrates the temporal evolution of standardized PBM preoperative 
check-up completion rates performed during the preoperative anesthesia consultation. Overall compliance increased from 40\% in May 2023 to 80\% in June 2025. Orthopedics showed the fastest improvement, reaching 90\% by August 2023 from 30\% in May 2023 while gynecology remained below 60\% throughout the period.

\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{figure.png}
\caption{Temporal trends of standardized PBM preoperative check-up completion rates by surgical specialty (May 2023 -- June 2025). The graph shows quarterly measurements for orthopedics (blue), cardiology (orange), gynecology (green), and overall hospital performance (dark blue).}
...
The indicators show an initial phase of growth followed by stagnation in recent periods,
indicating that passive monitoring has reached its limits.
We will target low-adherence specialties with microlearning modules, using these reports as metrics.

On the technical level, the current data stack is being refactored as part of a regional data warehouse initiative, enabling fully automated, web-accessible dashboards in the future.
